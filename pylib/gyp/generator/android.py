...
class AndroidMkWriter(object):
  ...
  def Write(self, qualified_target, relative_target, base_path, output_filename,
	...
	#			self.WriteLn('LOCAL_MODULE := ' + match.group(1))
	#			self.WriteLn('LOCAL_SRC_FILES := ' + lib)
  ...
  def WriteTarget(self, spec, configs, deps, link_deps, part_of_all,
    ...
    if 'android_extends' in spec:
      for line in spec['android_extends']:
        self.WriteLn(line)
      self.WriteLn('')
  ...
  def LocalPathify(self, path):
    ...
    local_path = posixpath.join('$(LOCAL_PATH)', self.path, path)
